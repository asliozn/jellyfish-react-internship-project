...
const ProfilePage = () => {
  ...
  const [unfAlert, setUnfAlert] = React.useState(false);
  ...
  const unfollowHandler = (profileUsername) => {
    if (user1) {
      dispatch(unfollowUser(profileUsername));
      setShow(true);
      setUnfAlert(true);
    } else {
      navigate("/login");
  ...
  const favoriteHandler = (slug) => {
    if (user) {
      ...
      dispatch(getArticlesByFavorited(user1?.username));
    } else {
      navigate("/login");
    }
  };
      ...
      {user1 ? (
        userID === user1.username ? (
          <>
            <div
              ...
              style={{ color: "#6963AD", marginBottom: "2%" }}
            >
              <div className="row">
                <div className="col-md-12">
                  <img
                    src="https://ps.w.org/metronet-profile-picture/assets/icon-256x256.png?rev=2464419"
                    className="profile-page-image-style"
                    alt="profile picture"
                  />
                  <h4>{user?.username}</h4>
                  <p>{user?.bio}</p>

                  <Link to="/settings" className="profile-page-link-style">
                    {" "}
                    {t("settings")}
                  </Link>
                </div>
              ...
              <div className="row">
                <div className="col-md-12">
                  ...
                  <Button
                    ...
                    variant="outlined"
                    onClick={() => {
                      followHandler(profile?.username);
                    }}
                  >
                    {t("follow")}
                  </Button>
        ...
        <>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <Link to="/login" className="profile-page-anchor">
              {t("l-page")}
            </Link>
          </div>
        </>
